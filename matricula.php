            ...
            <section>
              ...
              <div class="table-wrapper">
                <table>
                  ...
                  <tbody>
<?php
$SQL = "SELECT m.id_matriculas, m.materias_id_materias, m.turnos_id_turnos, m.usuarios_id_usuarios,
               a.materia ,
               t.turno ,
...
?>
            ...
            <section>
              <ul class="actions">
                  <li><a href="matricula_manutencao.php" class="button special">Associar Disciplina</a></li>
              </ul>
            </section>
        </div>
      </section>

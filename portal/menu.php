...
<header id="header">
    ...
    <nav id="nav">
        <ul>
                ...
                echo (in_array("S", [$_SESSION["ind_aluno"], $_SESSION["ind_professor"]]) ? "<li><a href=\"notas.php\">Frequência e Notas</a></li>" : "");
                echo (in_array("S", [$_SESSION["ind_aluno"], $_SESSION["ind_professor"]]) ? "<li><a href=\"senha.php\">Alterar Senha</a></li>" : "");
